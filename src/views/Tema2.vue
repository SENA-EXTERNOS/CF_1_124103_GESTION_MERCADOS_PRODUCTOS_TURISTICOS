...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center
      .col-10.col-lg-8
        ...
        AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--amarilla")
          .row(titulo="Dinámicas del turismo ")
            .col-12
              p.mb-0 En virtud de lo anterior, el turismo además de tener una dinámica económica en la que se enmarca el mercado turístico, también tiene dinámicas socioculturales que involucran a las comunidades anfitrionas con sus tradiciones y costumbres, además de sus dinámicas ambientales que involucran la fauna, la flora, el agua, el aire, el suelo, los ecosistemas y el paisaje de los destinos visitados. Por lo que es necesario involucrarse en los análisis y estrategias que se generan, en pro de su protección, conservación y salvaguardia.

          .row(titulo="Mercado turístico")
            .col-12
              p.mb-0 Así las cosas, el mercado turístico se define como "el estado y evolución de la oferta y la demanda del sector turístico, como lo mencionan García, R, Olmos, L. (2016) y complementa, De La Ballina, Francisco (2018) afirmando que “El <em>marketing</em> turístico debe comenzar por entender al turista, su comportamiento de compra, en primer lugar, y de su viaje, después." p. 57.
    ...
    p A continuación, se presenta un paralelo de los elementos del mercado vistos anteriormente con el equivalente de cada uno dentro del sector turístico:
       
    .row.justify-content-center.mt-4.mb-5
      .col-lg-10
        .titulo-sexto.bgr-titulo
          h5  Figura 2
          p.mb-0 #[em Paralelo entre los elementos del mercado y los elementos del mercado turístico]
        .row.justify-content-center
        ...
        .tarjeta.tarjeta--gris.p-3.mt-3
          p.text-small Cada elemento del mercado tiene un equivalente en los elementos del mercado turístico. A través de esta figura se aprecia cual es el equivalente de cada uno.

    
    

    h3  Elementos del mercado turístico      
    ...
    SlyderA(tipo="b").bg5.p-3.mb-5
      ...
      .row.justify-content-center.alig-items-center
        .col-10.col-lg-7.pt-4
          ...
          p <i class="fas fa-check" STYLE="Color: orange"></i> #[b Establecimientos de alojamiento y hospedaje:] “Se entiende por establecimiento hotelero o de hospedaje, el conjunto de bienes destinados por la persona natural o jurídica a prestar el servicio de alojamiento no permanente inferior a 30 días, con o sin alimentación y servicios básicos y/o complementarios o accesorios de alojamiento, mediante contrato de hospedaje, el cual es un contrato de arrendamiento, de carácter comercial y de adhesión, que una empresa dedicada a esta actividad celebra con el propósito principal de prestar alojamiento a otra persona denominada huésped, mediante el pago del precio respectivo día a día, por un plazo inferior a 30 días.” (MINCIT, 2017)
          
          p <i class="fas fa-check" STYLE="Color: orange"></i> #[b Establecimientos gastronómicos:] son aquellos establecimientos cuyo principal objetivo es la venta de alimentos y bebidas listas para el consumo, ubicados dentro del destino turístico e incluidos en el producto turístico.
      ...
      .row.justify-content-center.alig-items-center
        .col-10.col-lg-7.pt-4
          ...
          p <i class="fas fa-check" STYLE="Color: orange"></i> #[strong Empresas de transporte:]  son aquellas empresas que prestan servicio de transporte especializado para el turismo, ya sean viajes entre ciudades o países, estos no incluyen el transporte público al interior de la ciudad. Puede ser transporte marítimo, terrestre o aéreo.
      ...
      .row.justify-content-center.alig-items-center
        .col-10.col-lg-7.pt-4
          ...
          p <i class="fas fa-check" STYLE="Color: orange"></i> #[strong Agencias de viajes mayoristas:] las agencias de viajes mayoristas son aquellas que se dedican a generar y programar los planes turísticos que serán vendidos por las agencias de viaje minoristas y ejecutados por las agencias de viaje operadoras.
          
          p <i class="fas fa-check" STYLE="Color: orange"></i> #[strong Agencias de viajes minoristas:] las agencias de viaje minoristas son aquellas que se dedican a vender y ofrecer los planes de viajes turísticos, estas son agencias de viaje emisoras, es decir, envían al viajero hacia el destino, y suelen ser el primer contacto con el viajero, además estas pueden ser físicas y 
            i on-line.
    ...
    .row.mt-4.justify-content-center.mb-4
      ...
      .col-10.col-lg-10.mt-3
        p Como se ha mencionado anteriormente, el turismo es un fenómeno social, por lo tanto, además de la actividad económica que efectivamente se deriva de él, también hay un conjunto de factores sociales que hay que tener en cuenta.
        p A continuación, se invita a ver el video sobre el sistema turístico, el cual presenta los cinco subsistemas esenciales para su funcionamiento.

    figure.mb-5
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/968S1LizdH8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    ...
    .row.mt-4.justify-content-center.mb-4
      .col-10.col-lg-7
        p El producto turístico es usualmente mirado desde la oferta de los establecimientos turísticos, sin embargo, en el sector turístico este concepto trasciende la mirada empresarial para ubicarse en la del destino.   En algunos casos este concepto se suele confundir con otros, como el de recurso turístico, atractivo turístico, oferta turística y hasta patrimonio natural o cultural. Lo que sí es cierto es que este los incluye.
    ...
    p En la definición propuesta por Rivera (2018) se involucra la comunidad anfitriona, los prestadores logísticos y la institucionalidad que son elementos que hacen parte de un destino o área turística y en la de Acerenza (1990) se hace referencia a que es un producto compuesto. 
    p El producto turístico cuenta con seis (6) componentes que en algunos casos se fusionan entre sí dependiendo de las características del territorio como ya se podrá apreciar en la explicación de cada uno. Sus componentes son: 

    .row.justify-content-center.align-items-center.mt-4
      .col-6.col-lg-3
        figure
          img(src='@/assets/curso/temas/tema2/img14.svg' width='210' height='200')
      .col-6-.col-lg-3
        ol.lista-ol--cuadro
          li 
          ...
          li 
            .lista-ol--cuadro__vineta
              span 3
            | Actividades turísticas experienciales
          li 
            .lista-ol--cuadro__vineta
              span 4
            | Comunidad local
    ...
    p Recuerde explorar los demás recursos que se encuentran disponibles en este componente formativo, para ello diríjase al menú principal en donde encontrará la síntesis, la actividad didáctica, el material complementario, entre otros.
